export default function PanoramaGeral() {
    return (
        <div className="flex justify-center items-center">
            <div className="w-300 gap-5 p-6 bg-amber-50 flex flex-col rounded-2xl shadow-xl/30 shadow-sky-600 border border-sky-600">
                <div className="flex items-center gap-2">
                            <p className="w-1 h-6 rounded bg-sky-600"></p>
                            <h1 className="text-xl font-bold">Panorama Geral do Estado</h1>
                </div>
                <div className="grid grid-cols-4 gap-10">
                    <div className="flex flex-col shadow-xl/30 p-7 rounded-2xl">
