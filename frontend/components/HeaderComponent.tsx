...
import AcessibilidadeComponent from './AcessibilidadeComponent';
        ...
        <header className="flex justify-between items-center p-6 text-white">     
            <div className="flex items-center">
                <Link href="/" aria-label="Ir para a página inicial">
                    <Image className="h-20 w-[120px] object-contain" src="/logo.png" width={120} height={80} alt="Logotipo do Mapa Social do Maranhão" priority />
                </Link>
                <div>
            ...
            <div className="flex items-center gap-4 md:hidden">
                <button className="text-[#061F56] text-[20px] font-bold p-2 rounded-2xl hover:text-[#790000] md:hidden" aria-label="Abrir menu de navegação" aria-expanded={menuAberto} aria-controls="menu-mobile" onClick={() => {
