                    ...
                    <div className="group/div bg-white rounded-2xl p-7 shadow-2x border border-gray-300 hover:border-sky-600 transition-all duration-300 hover:-translate-y-1">
                        <div className="flex flex-col gap-8">
                            <div className="flex justify-between">
                                ...
                                <div className="w-10 h-10 bg-sky-600 md:bg-black group-hover/div:bg-sky-600 transition-colors duration-300" style={{ maskImage: `url('mao-segurando-agua.svg')`, maskSize: 'contain', maskRepeat: 'no-repeat' }}></div>
                            </div>
