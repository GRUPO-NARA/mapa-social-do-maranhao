...
export default function Saude(){
    ...
    const [isFiltroSaudeAplicado, setIsFiltroSaudeAplicado] = useState(false);
    ...
    function atualizarMunicipio(novoMunicipio: string) {
        ...
        setIsFiltroSaudeAplicado(false);
                      ...
                      <div className="relative grid items-end gap-8 lg:grid-cols-[1.5fr_1fr]">
                        <div className="max-w-3xl">
                          ...
                          <h1 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
                            Indicadores que ajudam a enxergar o cenário da saúde no estado e nos municípios
                          </h1>
