...
def TratamentoIPEADATA(arquivo: BinaryIO, informacoes_do_arquivo: dict) -> DataFrame:
    ...
    try:
        tabela = pd.read_csv(arquivo, skiprows=1, sep=';', encoding='utf-8', on_bad_lines='skip')
    except UnicodeDecodeError:
        # Tenta com encoding latin-1 se utf-8 falhar
        arquivo.seek(0)
        tabela = pd.read_csv(arquivo, skiprows=1, sep=';', encoding='latin-1', on_bad_lines='skip')
