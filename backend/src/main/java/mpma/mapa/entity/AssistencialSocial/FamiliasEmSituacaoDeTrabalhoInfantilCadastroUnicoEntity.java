...
@Entity
@Table(name = "familias_em_situacao_de_trabalho_infantil_cadastro_unico", schema = "assistencia_social")
public class FamiliasEmSituacaoDeTrabalhoInfantilCadastroUnicoEntity {
    @Id
