...
@Entity
@Table(name = "familias_em_situacao_de_rua_inscritas_cadastro_unico", schema = "assistencia_social")
public class FamiliasEmSituacaoDeRuaInscritasCadastroUnicoEntity {
    @Id
