...
import mpma.mapa.service.Estadual.EstadualService;
...
@Tag(name="Estadual", description = "Endpoints relacionados a dados gerais do Maranhão.")
public class EstadualController {

    private final EstadualService estadualService;
    private final Resposta resposta;

    public EstadualController(EstadualService estadualService, Resposta resposta) {
        this.estadualService = estadualService;
                                            ...
                                            value = """
                                                    {
                                                      ...
                                                      "Indicador da Requisição": "Lista dos Municípios do Estado do Maranhão"
                                                    }"""
                                    )
                            }
                    )
    ...
    public ResponseEntity<HashMap<String, Object>> municipios() {
        HashMap<String, Object> respostaDaRequisicao = resposta.CorpoDaResposta(
                "Lista dos Municípios do Estado do Maranhão",
                estadualService.municipiosDoEstado(),
                "200"
        );
