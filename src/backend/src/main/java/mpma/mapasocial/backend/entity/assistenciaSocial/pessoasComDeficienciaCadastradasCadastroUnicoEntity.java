...
@Entity
@Table(name = "pessoas_com_deficiencia_cadastradas_cadastro_unico", schema = "assistencia_social")
public class pessoasComDeficienciaCadastradasCadastroUnicoEntity {
    @Id
